            ...
            if pixel == (255, 0, 0):
                ...
                for yy in range(y + 1, height):
                    ...
                    if pixel_below == (0, 0, 255):  # pure blue
                        ...
                        break
                    elif pixel_below == (255, 255, 255) or pixel_below == (0, 0, 0):
                        break
                if found_water:
                    break
...
def analyze_image(image_path):
    ...
    water_threshold = height * 2  # Adjust as needed
        ...
        for x in range(width):
            ...
            # Check for meteors
                ...
                for yy in range(y + 1, height):
                    ...
                    elif pixel_below == (255, 255, 255) or pixel_below == (0, 0, 0):  # pure white or black
                        break  # Stop searching if a star or ground is encountered
                if found_water:
                    break
